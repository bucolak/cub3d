...
/*   Updated: 2025/11/08 12:29:50 by bucolak          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../../include/cub3d.h"

static void	control_so_we(t_map *map, t_header *header)
{
	int	i;
	int	end;
...
static void	control_no_ea(t_map *map, t_header *header)
{
	int	i;
	int	end;
...
{
	control_no_ea(map, header);
	control_so_we(map, header);
}
