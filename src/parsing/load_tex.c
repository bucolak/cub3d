...
/*   Updated: 2025/11/30 12:58:10 by bucolak          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (header->no_path) // bu kontrollerin sebebi map5te 2 tane north var örneğin, ozaman leak oluyodu o yüzden bi kere atama yapıyoruz
		return (-1);
