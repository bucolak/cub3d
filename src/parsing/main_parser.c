...
/*   Updated: 2025/11/05 18:38:46 by bucolak          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	main_parser(char *header_map, t_map *init, t_header *header)
{
	...
	header_parse(header_map, header, init); // burda fd'yi gönderince header_parse içinde raw_map'e malloc ile yer açabilmek için 
